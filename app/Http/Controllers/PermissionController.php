...
class PermissionController extends Controller {
    ...
    {
      // $value_to_insert = Input::get('permission_type');
      // var_dump($request->display_name); echo 'display name </br>';
      // var_dump($request->resource); echo 'resource </br>';
      // var_dump($request->crud_selected); echo 'crud_selected </br>';
      // var_dump($request->permission_type); echo 'permission_type</br>';
      // var_dump($value_to_insert); echo 'permission_type</br>';
      // die();
